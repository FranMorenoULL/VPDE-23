...
public class TankShooting : MonoBehaviour
{
    ...
    long vibrationMilliseconds = 100;
    int vibrationAmplitude = 128;
    ...
    private void Fire()
    {
        ...
        using (AndroidJavaObject effect =
               vibrationEffectClass.CallStatic<AndroidJavaObject>("createOneShot", vibrationMilliseconds, vibrationAmplitude)){

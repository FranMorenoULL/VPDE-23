...
public class TankShooting : MonoBehaviour
{
...
#if UNITY_PS4
    Color m_LightbarColour = Color.green;
#endif
    ...
    private void Start()
    {
        ...
        // We initialize the trophy manager
...
#if UNITY_PS4
        // Update PS4 controller's lightbar color
		m_LightbarColour = Color.Lerp (m_LightbarColour, Color.green, Time.deltaTime * 4f);
		PS4Input.PadSetLightBar(m_PlayerNumber - 1,
...
#if UNITY_PS4
        // Make PS4 controller's lightbar red
		m_LightbarColour = Color.red;
#endif

        // Update shot count for the trophies
        trophyManager.AddShot();
    }
}